...
# Initialize Flask app, set static and template folders for frontend
...
@app.route('/backup-done')
def backup_done():
    return render_template('backup-done.html')

@app.route('/backup-available')
def backup_available():
    return render_template('backup-available.html')

@app.route('/no-backup-found')
def no_backup_found():
    return render_template('no-backup-found.html')
